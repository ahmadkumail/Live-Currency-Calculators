  ...
  return (
    <div className="container mx-auto max-w-4xl py-12">
      <div className="space-y-6">
        <h1 className="text-4xl font-bold">About Live Currency Converter</h1>
        ...
        <div className="prose prose-lg max-w-none text-foreground">
          <p>
            In an increasingly connected world, navigating the complexities of currency exchange can be daunting. Whether you're a traveler, an international business, or sending money back home to your loved ones, you need a tool you can trust. That's where Live Currency Converter comes in.
          </p>
          ...
          <p>
            Thank you for choosing Live Currency Converter. We're excited to be part of your financial journey.
          </p>
        </div>
      </div>
    </div>
